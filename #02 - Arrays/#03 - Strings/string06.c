 ...
 * @date 2025-11-01
 * @brief Enunciado: 26. Faça um programa que verifique se um endereço de e-mail é válido ou não. 
 * Para um e-mail ser válido, deve possuir: 
 * 
 * - Um único símbolo '@' (mas que não seja o primeiro)
 * - Pelo menos um símbolo ponto '.' após  o símbolo '@' (mas que não seja o último)
 * - Não possuir espaços em branco nem outros caracteres especiais. 
 * 
 * Faça várias validações na mesma execução do programa.
 **/
