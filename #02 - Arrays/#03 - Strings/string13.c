 ...
 * @date 2025-11-03
 * @brief Enunciado: 33. Semelhante ao problema anterior, implemente o algoritmo para checar a validade de um número de cartão de crédito (pergunte ao professor o método de cálculo).
 **/
